...
The following result was first presented by Bernt Lindstr\"om.

\begin{prop}[Lindst\"orm's lemma]
Let $E$ be a finite set.
...
\begin{figure}[h]
\includegraphics[scale=1]{../imgs/consistent_colouring}%../imgs/consistent
...
\begin{figure}[h]
\includegraphics[scale=.5]{../imgs/simpson_lines}%../imgs/consistent
...
\begin{figure}[h]
\includegraphics[scale=.6]{../imgs/joints_problem}%../imgs/joints
...
\begin{thm}[Caratheodory Theorem]\label{thm:caratheodory}
Let $S \subseteq \R^d$.
